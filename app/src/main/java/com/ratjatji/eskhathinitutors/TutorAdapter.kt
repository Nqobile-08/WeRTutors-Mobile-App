...
class TutorAdapter(private var tutorsList: ArrayList<Tutors1>) :
    ...
    class TutorViewHolder(itemView: View, listener: onItemClickListener, tutorsList: ArrayList<Tutors1>) :
